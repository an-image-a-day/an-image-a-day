...
with io.open('src/aiad_web/__init__.py', encoding='utf8') as fp:
...
requirements = ['flask >=1.1.2,<2.0.0', 'nr.databind.core ==0.0.15', 'nr.databind.rest ==0.0.2', 'nr.utils.flask ==0.0.1', 'pyyaml']
...
setuptools.setup(
  ...
  description = 'Web API and page for An Image a Day.',
